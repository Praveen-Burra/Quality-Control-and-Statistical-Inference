########## Perinasal Perspiration subject13 ###########
...
plot(sub13_ses1_mc,type="l",xlim=c(0,1200),ylim=c(0,0.020),col="green",xlab=NA,ylab=NA,main="session1")
mtext(side=2,expression("["~PP ~degree~C^2~"]"),padj=-1.25)
mtext(side=1,expression("Time(sec)"),padj=2.2)

lines(sub13_ses1_ms,col="red")
lines(sub13_ses1_mb,col="black")



plot(sub13_ses2_mc,type="l",xlim=c(0,1200),ylim=c(0,0.020),col="green",xlab=NA,ylab = NA,main="session2")
lines(sub13_ses2_ms,col="red")
lines(sub13_ses2_mb,col="black")
mtext(side=2,expression("["~PP ~degree~C^2~"]"),padj=-1.25)
mtext(side=1,expression("Time(sec)"),padj=2.2)



plot(sub13_ses3_mc,type="l",xlim=c(0,1200),ylim=c(0,0.020),col="green",xlab=NA,ylab = NA,main="session3")
lines(sub13_ses3_ms,col="red")
lines(sub13_ses3_mb,col="black")
mtext(side=2,expression("["~PP ~degree~C^2~"]"),padj=-1.25)
mtext(side=1,expression("Time(sec)"),padj=2.2)



plot(sub13_ses4_mc,type="l",xlim=c(0,1200),ylim=c(0,0.020),col="green",xlab=NA,ylab = NA,main="session4")
lines(sub13_ses4_ms,col="red")
lines(sub13_ses4_mb,col="black")
mtext(side=2,expression("["~PP ~degree~C^2~"]"),padj=-1.25)
mtext(side=1,expression("Time(sec)"),padj=2.2)
...
plot(sub13_ses5_mc,type="l",xlim=c(0,1200),ylim=c(0,0.020),col="green",xlab=NA,ylab = NA,main="session5")
lines(sub13_ses5_ms,col="red")
lines(sub13_ses5_mb,col="black")
mtext(side=2,expression("["~PP ~degree~C^2~"]"),padj=-1.25)
...
title(expression('Subject 13 Perinasal Perspiration ['~PP~degree~C^2~']'),line = -1, outer = TRUE,font=3,cex=3)
