...
#final_scores 
####### to drop the levels from the each column of the dataframe ############
...
score1<-list(as.numeric(t(final_scores[1,])))
score2<-list(as.numeric(t(final_scores[2,])))
score3<-list(as.numeric(t(final_scores[3,])))
score4<-list(as.numeric(t(final_scores[4,])))
score5<-list(as.numeric(t(final_scores[5,])))
score6<-list(as.numeric(t(final_scores[6,])))
score7<-list(as.numeric(t(final_scores[7,])))
score8<-list(as.numeric(t(final_scores[8,])))
score9<-list(as.numeric(t(final_scores[9,])))
score10<-list(as.numeric(t(final_scores[10,])))
score11<-list(as.numeric(t(final_scores[11,])))
score12<-list(as.numeric(t(final_scores[12,])))
score13<-list(as.numeric(t(final_scores[13,])))
score14<-list(as.numeric(t(final_scores[14,])))
score15<-list(as.numeric(t(final_scores[15,])))
