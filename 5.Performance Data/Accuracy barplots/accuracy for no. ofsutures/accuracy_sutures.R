...
mydata3<- read.csv("C:\\Users\\Satya Praveen\\Desktop\\STATS FINAL PROJECT\\Methodist microsurgery with output\\MicrosurgeryPerformance.csv")
mydata3
...
mydata4$Sutures.1<-as.numeric(as.character(mydata4$Sutures.1))
...
for (i in 1:15){
  ...
  Number_of_sutures <-c(mydata4$Sutures.1[i],mydata4$Sutures.2[i],mydata4$Sutures.3[i],mydata4$Sutures.4[i],mydata4$Sutures.5[i])
